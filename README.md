...
- Pilot freeze: `npm run pilot:freeze` (v0.1.23 Launch readiness pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.23` (MVP → … → ops remind-answer close-loop → launch readiness); `npm run pilot:freeze`
