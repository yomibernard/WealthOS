...
- Pilot freeze: `npm run pilot:freeze` (v0.1.19 Ops care remind pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.19` (MVP → … → admin WealthAI ops → ops care remind); `npm run pilot:freeze`
