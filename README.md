...
- Pilot freeze: `npm run pilot:freeze` (v0.1.12 customer notification triage pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.12` (MVP → … → adviser triage → customer triage); `npm run pilot:freeze`
