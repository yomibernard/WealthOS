...
- Pilot freeze: `npm run pilot:freeze` (v0.1.11 adviser notification triage pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.11` (MVP → … → adviser notifications → triage); `npm run pilot:freeze`
