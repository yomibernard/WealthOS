...
- Pilot freeze: `npm run pilot:freeze` (v0.1.15 Adviser book next-steps pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.15` (MVP → … → Home next-steps → adviser book next-steps); `npm run pilot:freeze`
