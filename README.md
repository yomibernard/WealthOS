...
- Pilot freeze: `npm run pilot:freeze` (v0.1.21 Adviser ops-remind cues pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.21` (MVP → … → ops queue care remind → adviser ops-remind cues); `npm run pilot:freeze`
