...
- Pilot freeze: `npm run pilot:freeze` (v0.1.18 Admin WealthAI ops next-steps pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.18` (MVP → … → admin/ops next-steps → admin WealthAI ops); `npm run pilot:freeze`
