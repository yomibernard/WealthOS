...
- Pilot freeze: `npm run pilot:freeze` (v0.1.10 adviser notification centre pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.10` (MVP → … → close-loop → adviser notifications); `npm run pilot:freeze`
