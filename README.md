...
- Pilot freeze: `npm run pilot:freeze` (v0.1.20 Ops queue care remind pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.20` (MVP → … → ops care remind → ops queue care remind); `npm run pilot:freeze`
