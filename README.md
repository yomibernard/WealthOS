...
- Pilot freeze: `npm run pilot:freeze` (v0.1.13 Wealth Inbox triage pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.13` (MVP → … → customer triage → inbox triage); `npm run pilot:freeze`
