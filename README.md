...
- Pilot freeze: `npm run pilot:freeze` (v0.1.16 Adviser WealthAI book next-steps pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.16` (MVP → … → adviser book next-steps → adviser WealthAI book); `npm run pilot:freeze`
