...
- Pilot freeze: `npm run pilot:freeze` (v0.1.17 Admin/ops next-steps pack)
...
- **Release** — git tags `v0.1.0`–`v0.1.17` (MVP → … → adviser WealthAI book → admin/ops next-steps); `npm run pilot:freeze`
