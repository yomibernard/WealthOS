...
- [ ] `npm run pilot:freeze` green (0.1.11 adviser notification triage pack)
...
**Freeze tag / commit:** `v0.1.11` (adviser notification triage; notifications `v0.1.10`; close-loop `v0.1.9`; care receipts `v0.1.8`; WealthAI care `v0.1.7`; customer care `v0.1.6`; ops care `v0.1.5`; care UX `v0.1.4`; care `v0.1.3`; trust `v0.1.2`; ops `v0.1.1`; MVP `v0.1.0`)
