...
- [ ] `npm run pilot:freeze` green (0.1.6 customer care loop pack)
...
**Freeze tag / commit:** `v0.1.6` (customer care; ops care `v0.1.5`; care UX `v0.1.4`; care `v0.1.3`; trust `v0.1.2`; ops `v0.1.1`; MVP `v0.1.0`)
